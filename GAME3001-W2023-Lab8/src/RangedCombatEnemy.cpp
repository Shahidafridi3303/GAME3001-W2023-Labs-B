...
{
	auto scene = dynamic_cast<PlayScene*>(m_pScene); // alies for play Scene
	...
	//attack acation algorithm

	// new for lab 8
	// need to get the target object for the play scene
	...
	// wait for number of frames before firing again = frame delay
